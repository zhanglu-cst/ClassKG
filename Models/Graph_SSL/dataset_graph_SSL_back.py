...
class Graph_Keywords_Dataset_SSL(DGLDataset):
    ...
    def __init__(self, cfg, logger, keywords: KeyWords, sentences_vote, labels_vote, GT_labels):
        ...
        self.build_all(sentences_vote, labels_vote, GT_labels)
    ...
    def build_all(self, sentences_vote, labels_vote, GT_labels):
    ...
    def __build_subgraph_set_with_sentence__(self, sentences, labels_all, GT_labels):
        ...
        return subgraphs, labels, res_GT, res_sentences
