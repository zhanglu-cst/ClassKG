...
class Graph_Keywords_Dataset(DGLDataset):
    def __init__(self, cfg, logger, keywords: KeyWords, sentences_vote, labels_vote, sentences_eval, labels_eval,
        ...
        self.build_all(sentences_vote, labels_vote, sentences_eval, labels_eval)
    ...
    def build_all(self, sentences_vote, labels_vote, sentences_eval, labels_eval):
        self.build_large_graph(sentences_vote, labels_vote)
        self.pretrain_large_graph()
        if (self.istrain):
            self.subgraphs, self.labels = self.__build_subgraph_set_with_sentence__(sentences_vote, labels_vote)
        else:
            self.subgraphs, self.labels = self.__build_subgraph_set_with_sentence__(sentences_eval, labels_eval)
    ...
    def __getitem__(self, index):
        return self.subgraphs[index], self.labels[index]
